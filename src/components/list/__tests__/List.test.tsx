...
describe("List component", () => {
    ...
    it("renders Grid, Pagination and AppModal in the normal flow and wires search/setSearch and onClose behaviour", () => {
        const apps = Array.from({ length: 3 }).map((_, i) => ({
            app_id: `app${i + 1}`,
            name: `App ${i + 1}`,
            color: "#000",
            icon: "",
        ...
        // Pagination next page button present
